...
const submitForm = () => {
  ...
  validateReason()
  if (errors.value.confirmPassword || errors.value.reason) return
}
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-else-if="/\bfriend\b/i.test(formData.reason)"
                  class="text-success">Great to have a friend</div>
          </div>
          <div class="mb-3">
            <label for="suburb" class="form-label">Suburb</label>
            <input id="suburb" type="text" class="form-control"
                  v-model="formData.suburb" />
            <small class="text-muted">model: {{ formData.suburb }}</small>
          </div>
